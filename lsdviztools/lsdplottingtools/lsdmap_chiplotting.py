...
def BasicChiPlotGridPlot(FileName, DrapeName, chi_csv_fname, thisPointData, thiscmap='gray',drape_cmap='gray',
    ...
    ax2.set_xlabel(colorbarlabel,labelpad=l_pad)
...
def StackedProfilesGradient(chi_csv_fname, FigFileName = 'Image.pdf',
    ...
    if cbar_loc != "None":
        ...
        if cbar_loc == 'top':
            ax2.set_xlabel(colorbarlabel, labelpad=5)
        elif cbar_loc == 'bottom':
            ax2.set_xlabel(colorbarlabel, labelpad=5)
        elif cbar_loc == 'left':
            ax2.set_ylabel(colorbarlabel, labelpad=-75,rotation=90)
        elif cbar_loc == 'right':
            ax2.set_ylabel(colorbarlabel, labelpad=10,rotation=270)
